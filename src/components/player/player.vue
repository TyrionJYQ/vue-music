          ...
          <div class="middle-l" ref="middleL">
            <div class="cd-wrapper" ref="cdWrapper">
              <div class="cd" ref="imageWrapper" >
                <img ref="image"  class="image" :src="currentSong.image" :class="cdcls" >
              </div>
            </div>
  ...
  export default {
    ...
    methods: {
      ...
      onProgressBarChange(percent) {
        ...
        console.log('duration:' + this.currentSong.duration)
      ...
      middleTouchMove(e) {
        ...
        this._changeCurrentShow(offsetWidth, opacity, 0)
      },
      middleTouchEnd(e) {
        let offsetWidth
        let opacity
        ...
        this._changeCurrentShow(offsetWidth, opacity, 500)
        this.touch.initiated = false
      },
      showPlaylist() {
        this.$refs.playlist.show()
      },
      // cd lyric style change
      _changeCurrentShow(offsetWidth, opacity, time) {
