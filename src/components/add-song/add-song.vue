  ...
  <transition name="slide">
    <div class="add-song" v-show="showFlag" @click.stop>
      ...
      <div class="search-box-wrapper">
        <search-box placeholder="搜索歌曲"ref="searchBox" @query="onQueryChange">
        </search-box>
      </div>
        ...
        <div class="list-wrapper">
          <scroll v-if="currentIndex===0" :data="playHistory" class="list-scroll" ref="songList">
            <div class="list-inner">
              <song-list :songs="playHistory" @select="selectSong" ref="searchList"></song-list>
            </div>
          </scroll>
      ...
      <top-tip ref="topTip">
        <div class="tip-title">
          <i class="icon-ok"></i>
          <span class="text">
            <span style="color: red">{{songName}}</span> 已经添加到播放列表
          </span>
        </div>
      </top-tip>
    </div>
